...
$(document).ready(function() {
	...
	//ejectuar validar_compra on ready para desactivar boton de compra por defecto
	validar_compra();
	///////////////////////////
...
////////////Selector de div
	...
	var y=0;//contador para verificar datos de envio de usuario registrado
	var envios_esta_activado=0;
...
///////////Activar envios
    ...
    $("#necesita_envio").click(function() {
    	...
    	validar_compra();
            ...
            if(y==1){//solo se valida la primera vez que se presiona
            	validarCompraConEnvioAlSeleccionarBotonEnvio();
            }
		...
		$("#departamento").keyup(function(){
			...
			if(envios_esta_activado==true){
				...
				if(nombre_esta_validado==true&&apellido_esta_validado==true&&dni_esta_validado==true&&email_esta_validado==true&&cod_area_esta_validado==true&&telefono_esta_validado==true&&provincia_esta_validado==true&&ciudad_esta_validado==true&&cp_esta_validado==true&&calle_esta_validado==true&&altura_esta_validado==true&&piso_esta_validado==true && departamento_esta_validado==true){
					...
					$("#carrito-checkout-btn-comprar").css("background-color","rgb(255,106,0)");
			...
			function validarCompraAlCargar(){
				...
				// var tipo_dni;
				 ...
				 if(nombre.length!=0 && apellido.length!=0 && dni.length!=0 && email.length!=0 && cod_area.length!=0 && telefono.length !=0){
			...
			function validarCompraConEnvioAlSeleccionarBotonEnvio(){
